    ...
    <div class="container-app py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="/" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">Budget Estimator</a></li>
                    <li><span class="text-gray-400 dark:text-gray-500">NDA Tool <span class="badge-soon ml-1">Soon</span></span></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="https://techgeeta.com/about" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">About Us</a></li>
                    <li><a href="https://techgeeta.com/blog" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">Blogs</a></li>
                    <li><a href="https://techgeeta.com/contact" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">Contact</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
                    ...
                    <div class="flex items-center space-x-4 text-sm">
                        <a href="https://techgeeta.com/privacy-policy" class="text-gray-500 hover:text-gray-700 transition-colors">Privacy Policy</a>
                        <a href="https://techgeeta.com/disclaimer" class="text-gray-500 hover:text-gray-700 transition-colors">Disclaimer</a>
                    </div>
                </div>
