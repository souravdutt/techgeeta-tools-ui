@props(['activeRoute' => request()->route()->getName()])
...
<nav class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="/" class="nav-link {{ $activeRoute === 'estimator.index' ? 'active' : '' }} text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">
                ...
                <a href="#" class="nav-link text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">
                    ...
                    NDA Generator
                    <span class="badge-soon bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">Soon</span>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-4">
                <!-- Theme Toggle -->
                <button id="theme-toggle" class="p-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg transition-colors duration-200" title="Toggle theme">
                ...
                <a href="https://techgeeta.com/contact" class="btn-secondary">
                    Contact Us
                </a>
            </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-colors duration-200">
        <div class="px-4 py-3 space-y-3">
            <a href="/" class="mobile-nav-link {{ $activeRoute === 'estimator.index' ? 'active' : '' }} text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">
            ...
            <a href="#" class="mobile-nav-link text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <!-- Document outline -->
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 3h9l5 5v13a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1z" />
                    <!-- Signature line -->
                ...
                NDA Generator
                <span class="badge-soon ml-auto bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">Soon</span>
            </a>

            <div class="pt-3 border-t border-gray-200 dark:border-gray-700">
                <!-- Theme Toggle (Mobile) -->
                <button id="theme-toggle-mobile" class="mobile-nav-link w-full text-left cursor-pointer text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">
                    <!-- Sun Icon (shown in dark mode) -->
                ...
                <a href="https://techgeeta.com/contact" class="mobile-nav-link text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">
                    <svg class="w-4 h-4 mr-3 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
